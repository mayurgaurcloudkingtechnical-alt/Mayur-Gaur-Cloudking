          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <h2 className="text-xl font-bold text-white">Course Overview & Objectives</h2>
                </div>
              ...
              <div className="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-6">
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2.5">
                      ...
                      <h2 className="text-xl font-bold text-white">Complete Course Curriculum</h2>
                    </div>
                ...
                <div className="space-y-4">
                  {course.modules.map((mod, idx) => (
                    <div
                      key={mod.id}
                      className="border border-slate-800 rounded-2xl p-5 hover:border-emerald-500/50 transition-colors bg-slate-950/70 space-y-3 shadow-md"
                    >
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <Badge variant="outline" className="text-[11px] bg-slate-900 text-slate-300 border-slate-700 shrink-0">
                      ...
                      {mod.lessons.length > 0 && (
                        <div className="pt-2 border-t border-slate-800 grid grid-cols-1 sm:grid-cols-2 gap-2">
                          {mod.lessons.map((lesson) => (
                            <div
                              key={lesson.id}
                              className="flex items-center gap-2 text-xs text-slate-300 p-2.5 rounded-xl bg-slate-900/90 border border-slate-800 font-medium"
                            >
              ...
              <div className="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-4">
                <h2 className="text-xl font-bold text-white">Eligibility & Recommended Prerequisites</h2>
                <div className="flex items-start gap-3 text-sm text-slate-300">
                  <CheckCircle2 className="h-5 w-5 text-emerald-400 shrink-0 mt-0.5" />
                  <div>
                    <p className="font-semibold text-white">Target Learners:</p>
                    <p className="text-slate-400 mt-0.5">{course.eligibility || "Open to graduates and technology enthusiasts"}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-xl space-y-4">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-bold text-white">Faculty & Mentors</h2>
                  <Link
                    href="/trainers"
                    className="text-xs font-semibold text-emerald-400 hover:text-emerald-300 hover:underline flex items-center gap-1"
                  >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="p-4.5 rounded-2xl border border-slate-800 bg-slate-950/70 space-y-2 hover:border-emerald-500/50 transition-colors shadow-md">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 text-slate-950 flex items-center justify-center font-bold text-sm shrink-0 shadow-xs">
                        MG
                      </div>
                  ...
                  {(course.slug.includes("linux") ||
                    ...
                    <div className="p-4.5 rounded-2xl border border-slate-800 bg-slate-950/70 space-y-2 hover:border-teal-500/50 transition-colors shadow-md">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-600 text-slate-950 flex items-center justify-center font-bold text-sm shrink-0 shadow-xs">
                          NS
                        </div>
                        <div className="min-w-0">
                          <div className="flex items-center gap-1.5">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-900/90 p-6 rounded-3xl border border-slate-800 shadow-xl space-y-4">
                <h3 className="text-base font-bold text-white">What You Receive</h3>
              ...
              <div className="bg-emerald-950/60 p-6 rounded-3xl border border-emerald-800/80 space-y-3 shadow-xl">
                <h3 className="text-base font-bold text-emerald-300">Have Questions?</h3>
                ...
                <div className="pt-1">
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-xs font-bold text-emerald-300 hover:text-emerald-100 underline"
                  >
