...
import { GraduationCap, Award, ShieldCheck, CheckCircle2, Sparkles, Building2, BookOpen, Users, Compass } from "lucide-react";
...
export default async function DrPreetiGlobalUniversityPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-950 text-slate-100 selection:bg-sky-500 selection:text-white">
      ...
      <section className="relative overflow-hidden border-b border-slate-800/80 bg-gradient-to-b from-[#050b14] via-[#0b172a] to-[#071322] py-16 sm:py-20 lg:py-24">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-sky-500/15 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute top-1/4 -right-20 w-[450px] h-[450px] bg-indigo-600/15 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
          <div className="max-w-3xl space-y-5">
            {/* Top Pill Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gradient-to-r from-sky-500/20 to-indigo-500/20 border border-sky-400/40 text-sky-300 text-xs font-bold uppercase tracking-wider backdrop-blur-md shadow-xs">
      ...
      <section className="relative py-12 sm:py-16 bg-gradient-to-b from-[#071322] via-slate-950 to-[#040811] flex-1">
