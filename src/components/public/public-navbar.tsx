...
export function PublicNavbar({ userRole }: PublicNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-800/80 bg-slate-950/90 backdrop-blur supports-[backdrop-filter]:bg-slate-950/80 shadow-lg">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            return (
              <Link
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold tracking-wide transition-all ${
                  isActive
                    ? "text-emerald-400 bg-emerald-950/60 border border-emerald-500/30 font-bold shadow-sm shadow-emerald-950/50"
        ...
        <div className="hidden md:flex items-center gap-2">
          <Button
            ...
            size="sm"
            variant="ghost"
            className="text-emerald-400 hover:text-emerald-300 hover:bg-emerald-950/40 text-xs h-9 px-2.5 font-bold flex items-center gap-1.5 border border-emerald-500/40"
          >
          ...
          {userRole ? (
            <Button asChild size="sm" className="bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-950/50 text-xs h-9 px-3.5 font-bold">
            ...
            <>
              ...
              <Button asChild size="sm" className="bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-950/50 text-xs h-9 px-3 font-bold">
              ...
              <Button asChild variant="outline" size="sm" className="border-slate-700 hover:border-slate-600 bg-slate-900/60 text-slate-200 hover:bg-slate-800 text-xs h-9 px-3 font-semibold">
        ...
        <button
          ...
          className="rounded-lg p-2 text-slate-300 hover:bg-slate-900 md:hidden focus:outline-none focus:ring-2 focus:ring-emerald-500"
      ...
      {/* Mobile Menu Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden border-b border-slate-800 bg-slate-950 px-4 pt-2 pb-6 space-y-3 shadow-2xl">
